...
| AI assistants | Kilo, github-copilot, OpenCode, GitHub Copilot | Planning, code generation, workflow automation, multi-agent orchestration |
...
| sqlite3 | Query and back up Kilo session database tables |
