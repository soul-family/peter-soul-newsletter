...
## 1.2 State the goal as a result, not an action keyword
...
## 1.3 Be specific enough to constrain, specific enough to verify
...
## 1.5 Include the "why" for anything non-obvious
...
- > 120 words: split it. It either contains multiple tasks or contains
  material that belongs in `02` (context) rather than the ask.
