...
| `06-hooks-and-automation.md` | Service/prompt hooks to automate the rules, telemetry for stats | all (persistently) |
...
4. **Persist**: for any red stat you see 3+ times, stop fixing it by memory and hook it — see `06-hooks-and-automation.md`.
