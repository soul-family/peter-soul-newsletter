...
- A-1: Verify all prep commit file dates match date_map.csv (created, modified, accessed)
...
- A-6: Verify all HTML files in prep commits declare ISO-8859-1 charset
- A-7: Verify no UTF-8 charset declarations exist in prep commit HTML files
- A-8: Verify Windows-1252 byte encoding is valid across all prep commit HTML files
- A-9: Verify no broken href patterns exist in prep commit HTML files
...
- A-12: Verify family tree index links use trailinA-slash URLs
- A-13: Verify all prep commits have progressive index pages
- A-14: Verify README.md and src-preps/commit0/README.md are identical
