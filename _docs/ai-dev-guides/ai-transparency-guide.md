...
### Interaction Logging
AI assistants like Kilo log all interactions for transparency:
...
For troubleshooting and best practices, see [kilo-dev-guide.md](../dev-guides/kilo-dev-guide.md).
...
See also: [kilo-dev-guide.md](../dev-guides/kilo-dev-guide.md) | [skills-guide.md](skills-guide.md)
