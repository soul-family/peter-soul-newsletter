    ...
    Skills are pre-written markdown workflows stored in `.skills/`. Each skill defines a **Goal**, **When to Use**, **Prerequisites**, **Workflow**, and **Verification** checklist. Loading a skill injects its instructions into the current session.
...
| Knowledge retention | All decisions, sources, and tools persist in version-controlled logs |
    ...
    **Script:** `.dev-scripts/ai-sessions/ai-sessions-backup.py`
