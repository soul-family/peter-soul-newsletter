...
Quick reference for contributors who need to back up AI co-developer sessions and update project statistics.

## Prerequisites

- Python 3.x
- Access to the AI co-developer SQLite database
- `.dev-scripts/ai-assistant/scripts/` in the project
...
```bash
python .dev-scripts/ai-assistant/scripts/ai-sessions-stats.py \
  --db-path .ai-activity/ai-sessions/<developer>/<project>-sessions.db \
  --incremental \
  --developer <developer-id>
```
...
- Database: `.ai-activity/ai-sessions/<developer>/<project>-sessions.db`
- Stats: `.ai-activity/ai-sessions/<developer>/<project>-sessions.stats.json`
...
- AI session backup skill — `.skills/ai-session-backup/skill.md`
- Session stats units — `_docs/dev-guides/ai-dev-guides/session-stats-units.md`
- Audit guide — `_docs/dev-guides/audit/readme.md`
- Developer config reference — `.dev-scripts/ai-assistant/scripts/ai-developers.jsonc`
