...
### Commands
- `/help` — Get Kilo help
- `/review` — Request code review (see [github-management.md](../dev-tools/github-management.md))
...
```bash
python .dev-scripts/ai-assistant/scripts/ai-sessions-backup.py --db-path <kilo.db> --developer kilo-code --current-session
```
...
See also: [github-management.md](../dev-tools/github-management.md) | [ai-transparency.md](../ai-dev-guides/ai-transparency.md) | [skills-guide.md](../ai-dev-guides/skills-guide.md)
