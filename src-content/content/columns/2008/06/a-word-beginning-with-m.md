...
OK then, what does momentum mean to a physicist? It is simply the weight of an object (actually the proper word here is*mass*) multiplied by its speed:_mv_. An important property of momentum is that it's directional, which means that if two vehicles with equal amounts of it collide head-on - sorry to dramatize - their momentums will cancel and vanish, and both will stop.

If instead one vehicle had more momentum before the collision, because of being heavier and/or moving faster, it would win and push the other back. This is decided entirely by momentum, and not by their kinetic energy (*mv*2). But naturally they do lose KE as well: all the amount lost changes ultimately into heat and dissipates into the environment.
