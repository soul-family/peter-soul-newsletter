...
It's also a list that has usefully supplied topics for some of these columns. But there's one thing I haven't focused on before:_Gear_, or (better for the purposes of this column)_Gears_. Why do we need them? An engineer might say that they are for converting the torque and the rotary speed of the engine to values that better suit the driving wheels, the inertial load, the frictional drag, the road speed, the acceleration and the gradient. But I'm a physicist who likes to try to explain things more gently than that!
