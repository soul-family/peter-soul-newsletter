...
And suppose radio contact was lost? What if someone ran out of fuel, or there was an accident? Will my writing stay legible, if the steering wheel is twitching under my pad of paper all the time? Will I be permitted to doze off? I investigated by taking a look first at the SARTRE website (click [here)](http://www.sartre-project.eu/en/Sidor/default.aspx)and then at some papers they've published, which report the research work to date and the plans for setting up and running the road-train scheme properly.
