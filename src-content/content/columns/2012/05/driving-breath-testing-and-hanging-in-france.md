...
From July, all drivers in France will be required to carry an approved single-use breathalyser kit in the vehicle, so that they can check they are safe to drive and not in a state of*brit*(this word is another curiosity: did the French decide to drop the prefix "_in-_", or did we decide to add it?). You may regard the new regulation as good, or alternatively, bad news. The bad - or good - news is that it won't be enforced until November! And even then the fine for having mislaid or already used your kit will be only 11 euros.

OK, surely any measure that raises awareness of the dangers of drink-driving is a good thing, and within France these*thylotests*will be available for just a euro or two. But do you believe that's what they will be sold for on the ferries, as you cross from the UK? And then is it likely that drivers will actually want to put themselves to the test after they've had a drink? Especially if doing so will leave them without the working breathalyser needed for satisfying a*gendarme*.
