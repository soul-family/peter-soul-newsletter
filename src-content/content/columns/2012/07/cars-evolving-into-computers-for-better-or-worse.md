...
A new type of lithium battery has just been announced, however, which seems to operate happily and efficiently anywhere between -30 and +45C, which is an extraordinarily wide range. Also promised for it is an extended lifetime, a lower overall cost, and a significantly higher mileage for the car that it's in, between charges. Production of this battery is expected to start next year.
