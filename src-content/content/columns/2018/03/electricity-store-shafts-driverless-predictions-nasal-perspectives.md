...
By the way, if you want to get an impression of the complexity of balancing our electricity supply, take a look at [www.gridwatch.templar.co.uk](http://www.gridwatch.templar.co.uk), where you will see displayed (a) the almost-up-to-the-minute power consumption in the UK, (b) how much each different energy source (coal, gas, nuclear etc) is supplying to satisfy it, and (c) how all these figures have varied over the past day, week, month and year.
