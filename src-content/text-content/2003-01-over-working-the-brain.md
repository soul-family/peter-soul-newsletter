...
And that's just a journey on foot! Driving a car introduces more tasks. How does the brain perform them all simultaneously? It's only possible because driving involves mostly automatic or semi-automatic actions. The brain can learn and perform an astonishing number of these, leaving our conscious selves to concentrate on hazards, such as the wobbling cyclist ahead.
...
But if the brain is so clever, why do I have difficulty sometimes in remembering simple things such as what the speed limit is, or which gear I am in? I confess that I often check the gear by glancing down at the rev counter and the speedometer: if the two needles are parallel, then I know I'm in 4th! Perhaps what is interfering with my memory is that the physicist in me is often noticing things and saying: I know why that happened (and maybe I can make a column of it).
