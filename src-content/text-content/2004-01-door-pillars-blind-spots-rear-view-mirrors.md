...
# Door pillars, blind spots, rear-view mirrors
...
A yachtsman friend once told me about a simple rule for night-time sailing at sea: if you observe a light getting closer to you, and it stays on a constant bearing (ie, its compass direction isn't changing), then you are on course for a collision!

If we apply this situation to driving, the risks seem smaller. Let's say there is another car on a road that is about to merge with yours, and the direction of the other vehicle (relative to your car) is constant. You might think that the danger would be obvious - by day or by night.
...
Meanwhile your other pillar - on the outside of the bend - is swinging round quickly and so may be hiding a vehicle or bicycle moving *faster* than you would normally expect (for it to remain in line with the pillar).

Even on a straight road, when I look around, in some ways I have a better view to the rear than to the front, thanks to the interior mirror and the two exterior ones - each of which has a blind-spot mirror stuck to it.

These little mirrors came with instructions to locate them at the inside corner of each main mirror, but I find them more effective when placed at the outside corners, giving me a view just slightly rear of sideways. Here they show either a rapidly moving reflection or an almost static one - and if it's the latter then I know I'm about to be overtaken (or, on the left side, undertaken).

Incidentally, if you too possess these little mirrors and the shine is wearing off them, then rather than unstick the whole unit and replace it with a new one, it's much easier just to extract the old and new reflectors and change them over.
