...
# Turning wheel-nuts and corners
...
Corrosion had spread unnoticed, and in sorrow I took her to the breaker's yard where they gave me a fiver in return. I spent this on a little bottle-jack, which I applied directly below each wheel axle of the next car ... and the next and the next (never finding the courage to get out the jack that came with each vehicle) right up to last year.

That's when I happened to notice the four jacking points provided on my Corolla, one beside each wheel arch. They ought to be safer than the central points on the old Morris, I thought - dare I try the proper jack? Well I did, nothing gave way and of course the job was rather easier. One old habit dead!
...
Let's think now about another cause of strain, namely hauling on the steering wheel to turn into a corner (OK, I'm recalling the time before I acquired the luxury of power steering). It's not surprising that some effort is required, when you consider the weight of the car that you are guiding round the bend - and how forcefully the wheel straightens out if you let it slip through your hands afterwards (not that you do, of course).

But here's a puzzle: on a frosty or icy corner the wheel becomes noticeably easier to turn. Given that the car is entering the curve at much the same speed and isn't skidding, how is it that less effort is needed?
