...
# Seeing after dark, handling jump-leads, buying a starter-pack
...
As it gets darker still, the eyes increase their sensitivity by making use of a different set of light-detecting cells in the retina. But these cells can't easily distinguish between colours, and they are mostly off-centre - so you see even less clearly in the exact direction you are looking.

Then there is the problem of glare from bright lights approaching. And lastly, everything looks different in the dark anyway! The kerb might show up only as a faint reflection of the light from someone else's headlights, the road surface is often hard to see, cyclists and pedestrians might only be indicated by the hint of a silhouette, and your reactions to whatever you do see could be slow too (simply because it is indistinct). Really it's a miracle that we don't have constant accidents when driving at night.

What bothers me is that as far as I know there's no simple standard way of testing how good people's eyes are in night conditions. I can understand that it would not be easy to do - for one thing, you would have to sit in darkness first until your eyes had fully adapted to it. But I would like to know if I can see better or worse in the dark than the average person. At present, I've no idea.

Changing the subject now, is it actually safe to do a jump-start either to your vehicle if the battery's flat, or to someone else's from yours? The answer has to be: read the manual! Modern cars have computer control and other electronics that are in danger of being destroyed by voltage spikes when the jump-leads are connected, or when the other car is started.

But let's suppose you are willing to take the risk: should the car with the good battery be running or not, when you connect/disconnect the leads? Should it be started at all, even, while you are trying to get the other car going? Well, some advice I've read says yes, some says no. I couldn't possibly comment. You must decide.

The question I can deal with - though I confess I had the wrong answer in my head for years - is which jump-lead should be attached first: the negative (black) or the positive (red)? All electricians, electronics experts and physicists know the importance of making reliable earthing connections to equipment and circuits, for safety and other reasons. Shouldn't you connect up the black jump-lead first, therefore, joining the two negative battery terminals and thus linking one car chassis to the other in a nice safe structure?
...
...Breaking off from typing, I discovered on the internet that there's a whole range of portable starter-packs available, with internal battery and jump leads. The bargain of the month was one in Maplin's, featuring also a tyre pump, a lamp, and a 12 V cigar-lighter output socket: half-price at £19.99. Irresistible! So I visited the Reading store: sorry sir, it's out of stock and no chance of more coming in. Back home I found the Maplin website, punched in an order, and the pack was delivered three days later (on a Sunday afternoon), all for £22.97.
